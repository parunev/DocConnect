...
@Operation(summary = "Send Custom 2FA verification code to specialist's email",
        description = "POST endpoint to send Custom 2FA verification code to specialist's email")
@ApiResponse(responseCode = "200", description = "Verification code sent successfully. Please check your email for the code")
@ApiResponse(responseCode = "400", description = "Specialist not found.", content = {@Content(mediaType = "application/json", schema = @Schema(implementation = VerificationResponse.class))})
...
public @interface ApiSendCodeSpecialist {
}
