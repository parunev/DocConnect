...
@ApiResponse(responseCode = "400", description = "User not found.", content = {@Content(mediaType = "application/json", schema = @Schema(implementation = LoginResponse.class))})
...
public @interface ApiVerifyCode {
}
